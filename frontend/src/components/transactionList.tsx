      ...
      <tbody>
        {transactions.map((t) => (
          <tr key={t.id} className="hover:bg-gray-50">
            <td className="border border-gray-300 px-4 py-2">{formatDate(t.transactionDateTime)}</td>
            ...
            <td className="border border-gray-300 px-4 py-2 text-right">{formatAmount(t.amount)}</td>
          </tr>
        ))}
      </tbody>
    </table>
